...
function query($query){
  ...
  $mapel = query("SELECT * FROM mapel Order By Kelas ASC");
  $guru = query("SELECT * FROM guru");
  $kelas = query("SELECT * FROM kelas");

  if (isset($_GET['kelas'])) {
  $kelasGET = $_GET['kelas'];
  $mapel = query("SELECT * FROM mapel WHERE Kelas='$kelasGET' Order By Kelas ASC");
}
?>
