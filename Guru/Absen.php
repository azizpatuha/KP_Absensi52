                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th><input type="teks" readonly class="form-control-plaintext" name="NISN<?=$no ?>"
                                            value="<?= $value["NISN"] ?>"></th>
                                    <td><input type="teks" readonly class="form-control-plaintext" name="Nama_Siswa<?=$no ?>" 
                                            value="<?= $value["Nama_Siswa"] ?>"></td>
                                    ...
                                    <td><input type="teks" readonly class="form-control-plaintext" name="Pertemuan<?=$no ?>" 
                                            id="Pertemuan" value="<?= $pertemuanGET ?>"></td>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="EditAbsen.php" method="get">
                                    ...
                                    <input type="teks" readonly class="form-control-plaintext" name="Kode_Mapel"
                                        value="<?= $value["Kode_Mapel"] ?>">
